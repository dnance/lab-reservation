...
if *action == "produce" {
err := produceMessage(key, topic, value, int32(*partition))
if err != nil {
fmt.Errorf("error producing message")
os.Exit(-1)
}
} else if *action  == "consume" {
err := common.ConsumeMessages(*topic, *partitions, *bufferSize, *brokerList, *offset)
if err != nil {
...
func produceMessage(key *string, topic *string, value *string, partition int32) error {
